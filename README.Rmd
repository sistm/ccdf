...
`citcdf` is a package for performing single-cell RNA-seq differential expression analysis and more generally **complex hypothesis testing**. 
...
**To install `citcdf`, you can download the development version on [GitHub](https://github.com/sistm/citcdf).**
